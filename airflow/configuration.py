...
class AirflowConfigParser(ConfigParser):
    ...
    def __init__(self, default_config=None, *args, **kwargs):
        ...
        self.defaults = ConfigParser(*args, interpolation=None, **kwargs)
        if default_config is not None:
            self.defaults.read_dict(default_config)
...
conf = AirflowConfigParser(default_config={
    'DEFAULT': {},
    ...
    'atlas': {'host': '',
        ...
        'sasl_enabled': 'False',
        'username': ''},
    'celery': {'broker_url': 'sqla+mysql://airflow:airflow@localhost:3306/airflow',
    ...
    'core': {'airflow_home': '/Users/ash/airflow',
        'base_log_folder': '/Users/ash/airflow/logs',
        'dag_concurrency': '16',
        'dag_run_conf_overrides_params': 'False',
        'dagbag_import_timeout': '30',
        'dags_are_paused_at_creation': 'True',
        'dags_folder': '/Users/ash/airflow/dags',
        ...
        'parallelism': '32',
        'plugins_folder': '/Users/ash/airflow/plugins',
        ...
        'sql_alchemy_conn': 'sqlite:////Users/ash/airflow/airflow.db',
    ...
    'dask': {'cluster_address': '127.0.0.1:8786',
            ...
            'tls_cert': '',
            'tls_key': ''},
    'elasticsearch': {'elasticsearch_end_of_log_mark': 'end_of_log',
            'elasticsearch_host': '',
 ...
 'mesos': {'authenticate': 'False',
         ...
         'task_cpu': '1',
         'task_memory': '256'},
 'operators': {'default_cpus': '1',
         'default_disk': '512',
         'default_gpus': '0',
         'default_owner': 'Airflow',
         'default_ram': '512'},
 'scheduler': {'authenticate': 'False',
         'catchup_by_default': 'True',
         'child_process_log_directory': '/Users/ash/airflow/logs/scheduler',
